...
- [제품 목표와 MVP](./product-brief.md)
- [폴더 구조](./folder-structure.md)
- [대표 정책 10개 조사](./policy-research.md)
...
- [2026-08-01 구현·결정 요약](./implementation-summary-2026-08-01.md)
- [현재 진행 상황](../progress.md)
- [남은 작업](../todo.md)

정책 추천은 사전 탐색 결과이며 최종 자격 판정이 아니다. 사용자 화면에는 기준 확인일, 추천 이유, 미확인 조건과 공식 신청 링크를 함께 제공한다.
