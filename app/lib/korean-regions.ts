...
export const koreanRegions: KoreanRegion[] = [
  ...
  { code: "29", name: "광주", sigungu: ["동구", "서구", "남구", "북구", "광산구"] },
  { code: "30", name: "대전", sigungu: ["동구", "중구", "서구", "유성구", "대덕구"] },
  { code: "31", name: "울산", sigungu: ["중구", "남구", "동구", "북구", "울주군"] },
  { code: "36", name: "세종", sigungu: ["세종시"] },
  {
    code: "41",
    name: "경기",
    sigungu: [
  ...
  { code: "50", name: "제주", sigungu: ["제주시", "서귀포시"] },
];

export function getRegion(code: string): KoreanRegion {
  return koreanRegions.find((region) => region.code === code) ?? koreanRegions[0];
}
